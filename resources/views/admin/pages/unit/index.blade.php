                ...
                <tbody>
                    @foreach ($satuans as $key => $satuan)
                        <tr class="bg-white border-b hover:bg-gray-50 text-black">
                            ...
                            <td class="w-auto items-center md:px-auto text-center justify-center m-2 flex">
                                <button
                ...
                <div class="p-6 space-y-6">
                    ...
                    <form action="{{ route('unit.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="namaSatuan" class="w-full border rounded-lg" id="name"
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="{{ route('unit.update', [$satuan->kdSatuan]) }}" method="post">
                            ...
                            <div>
                                <label for="name">Nama Satuan</label>
                                <input type="text" name="namaSatuan" class="w-full border rounded-lg" id="name"
                                    placeholder="Nama satuan" value="{{ $satuan->name }}" required>
                                <input type="hidden" name="slug" class="w-full border rounded-lg" id="slug"
                                    value="{{ $satuan->slug }}" required>
                            </div>
                            </p>
                    </div>
                    <!-- Modal footer -->
