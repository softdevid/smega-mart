...
@section('content')
    <main class="container">
        <div class="mx-auto grid max-w-full grid-cols-1 lg:max-w-full lg:grid-cols-2 lg:gap-x-6">
            ...
            <p
                class="col-start-1 sm:col-span-2 md:col-span-1 md:row-start-4 lg:row-start-3 mt-4 md:mt-2 px-2 md:px-4 lg:px-6 text-sm text-justify leading-6">
    ...
    <div class="mt-4 bg-white md:mt-6">
      <main class="container">
        <div class="mx-auto grid h-auto w-full py-2 md:py-3 grid-cols-1 items-center gap-4 md:grid-cols-2">
            <div>
