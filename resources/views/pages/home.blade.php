    ...
    <main class="container">
        <div class="mx-auto grid max-w-full grid-cols-1 lg:max-w-full lg:grid-cols-2 lg:gap-x-6">
            <div
                ...
                <h1 class="mt-1 pl-2 md:pl-4 lg:pl-6 text-lg font-oswald font-semibold text-white sm:text-slate-900 dark:sm:text-white md:text-2xl">Smega Mart
                </h1>
            </div>
            <div
            ...
            <dl
                class="row-start-2 mt-4 pl-4 md:pl-6 lg:pl-8 flex items-center text-xs font-medium sm:row-start-3 sm:mt-1 md:mt-2.5 lg:row-start-2">
