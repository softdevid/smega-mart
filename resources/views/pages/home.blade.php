...
@section('content')
    <main class="container">
        <div class="mx-auto grid max-w-full grid-cols-1 lg:max-w-full lg:grid-cols-2 lg:gap-x-6">
            ...
            <p
                class="col-start-1 mt-4 pl-2 text-sm leading-6 dark:text-slate-400 sm:col-span-2 md:col-span-1 md:row-start-4 md:mt-2 md:pl-4 lg:row-start-3 lg:pl-6">
                        ...
                        <div class="relative h-44 overflow-hidden rounded-lg md:h-96">
                            ...
                            <div class="absolute inset-0 z-10 translate-x-full transform transition-all duration-100 ease-in-out"
                                ...
                                <div class="mt-4 bg-white md:mt-6">
                                    <main class="container">
                                        <div
                                            class="mx-auto grid h-auto w-full grid-cols-1 items-center gap-4 px-2 md:grid-cols-2 md:px-4 lg:px-6">
                                            <div>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span
                                                            ...
                                                            <svg aria-hidden="true"
                                                                class="h-6 w-6 text-white dark:text-gray-800" fill="none"
                                            ...
                                            <div class="text-center">
                                                ...
                                                Kami memiliki produk yang lengkap dan pasti berkualitas. Kami menjual
                                                berbagai produk dari makanan
                                                ringan /
                                                jajanan, alat tulis dan lainnya. Pengecekan dan pemilihan produk yang tepat
                                                untuk menjamin produk
                                                berkualitas dan aman tentunya. Bermacam produk ada untuk memenuhi kebutuhan
                                                masyarakat sektiar dengan
                                                harga
                                            ...
                                            <div class="mb-12 max-w-[570px]">
                                                <div class="mt-8 flex w-full max-w-[370px]">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-body-color text-base underline">
                                                            <a href="https://smkn1purbalingga.sch.id/" target="_blank"
                                                                rel="noopener noreferrer">SMKN
                                                                1
                                                                Purbalingga</a>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="mt-8 flex w-full max-w-[370px]">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <a href="tel:+6281312008910" class="text-body-color text-base">+62
                                                            813-1200-8910</a>
                                                    </div>
                                                </div>
                                                <div class="mt-8 flex w-full max-w-[370px]">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-body-color text-base">Berada di sebelah SMK N 1
                                                            PURBALINGGA, Jl. Mayjend Sungkono
                                                            34 Kec. Kalimanah, Kab. Purbalingga</p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="w-full px-4 lg:p-8">
                                                    <div class="mb-12 max-w-[570px]">
                                                        <div class="mt-8 flex w-full max-w-[370px]">
                                                            ...
                                                            <div class="w-full">
                                                                <h4 class="text-dark mb-1 text-xl font-bold">Website
                                                                    Sekolah</h4>
                                                                <p class="text-body-color text-base underline">
                                                                    <a href="https://smkn1purbalingga.sch.id/"
                                                                        target="_blank" rel="noopener noreferrer">SMKN
                                                                        1
                                                                        Purbalingga</a>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <div class="mt-8 flex w-full max-w-[370px]">
                                                            ...
                                                            <div class="w-full">
                                                                <h4 class="text-dark mb-1 text-xl font-bold">Telepon</h4>
                                                                <a href="tel:+6281312008910"
                                                                    class="text-body-color text-base">+62 813-1200-8910</a>
                                                            </div>
                                                        </div>
                                                        <div class="mt-8 flex w-full max-w-[370px]">
                                                            <div
                                                            ...
                                                            <div class="w-full">
                                                                <h4 class="text-dark mb-1 text-xl font-bold">Lokasi</h4>
                                                                <p class="text-body-color text-base">Berada di sebelah SMK
                                                                    N 1 PURBALINGGA, Jl. Mayjend
                                                                    Sungkono
                                                                    34 Kec. Kalimanah, Kab. Purbalingga</p>
                                                            </div>
                                                        </div>
