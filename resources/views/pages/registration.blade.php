      ...
      <form action="/registration" method="post" class="space-y-6">
        ...
        <div>
          ...
          <input type="text" name="namaUser" id="namaUser"
            class="form-input @error('namaUser') form-input-invalid @enderror"
            value="{{ old('namaUser') }}" placeholder="Nama Lengkap" autofocus autocomplete="off" required>
          @error('namaUser')
        ...
        <div>
          ...
          <input type="text" name="email" id="email"
            ...
            value="{{ old('email') }}" placeholder="Nama Lengkap" autocomplete="off" required>
          @error('email')
            <p class="mt-2 text-sm text-red-600"><span class="font-medium">{{ $message }}</span></p>
          @enderror
        </div>
        ...
        <div>
          ...
          <input type="tel" name="noHp" id="noHp"
            class="form-input @error('noHp') form-input-invalid @enderror"
            value="{{ old('noHp') }}" placeholder="Nomor HP" autocomplete="off" required>
          @error('noHp')
            <p class="mt-2 text-sm text-red-600"><span class="font-medium">{{ $message }}</span></p>
          @enderror
        </div>
        <div>
          ...
          <input type="text" name="kabupaten" id="kabupaten"
            class="form-input @error('kabupaten') form-input-invalid @enderror"
            value="{{ old('kabupaten') }}" placeholder="Kabupaten" autocomplete="off" required>
          @error('kabupaten')
            <p class="mt-2 text-sm text-red-600"><span class="font-medium">{{ $message }}</span></p>
          @enderror
        </div>
        <div>
          ...
          <input type="text" name="kecamatan" id="kecamatan"
            class="form-input @error('kecamatan') form-input-invalid @enderror"
            value="{{ old('kecamatan') }}" placeholder="Kecamatan" autocomplete="off" required>
          @error('kecamatan')
            <p class="mt-2 text-sm text-red-600"><span class="font-medium">{{ $message }}</span></p>
          @enderror
        </div>
        <div>
          ...
          <input type="text" name="desa" id="desa"
            class="form-input @error('desa') form-input-invalid @enderror"
            value="{{ old('desa') }}" placeholder="Desa" autocomplete="off" required>
          @error('desa')
            <p class="mt-2 text-sm text-red-600"><span class="font-medium">{{ $message }}</span></p>
          @enderror
        </div>
