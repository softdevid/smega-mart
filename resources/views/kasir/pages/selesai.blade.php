...
@section('content')
    ...
    <div class="m-5">
        <a href="/kasir/show/{{ session('noFakturJualan') }}"
            class="rounded-lg bg-blue-500 p-2 text-white hover:bg-blue-800"><i class="fa fa-print"></i>
            Print</a>
        <a href="/kasir" class="rounded-lg bg-green-500 p-2 text-white hover:bg-green-800">Transaksi Baru</a>
    </div>
@endsection
